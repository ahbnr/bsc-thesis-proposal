...
components is usually difficult. % TODO: Redundant?
...
This thesis is based on % "new" correct? Really not mentioning authors of central source by name?
...
using a variant of Session Types. % (TODO: Konkreter).
...
\texttt{Fut<}\emph{anything}\texttt{>} & 1.5 weeks & & \\ % TODO: Vor oder nach pausierbaren Schedulern?
Type Syntax \& Parser & 2 weeks & & \\
Integrating AST & 1.5 weeks & & \\ % TODO: Wirklich hier runter tauschen?
